    ...
    <main class="dashboard d-flex">
        ...
        ?>
            ...
            <div class="button-add-student">
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@mdo">add Grave</button>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <button type="submit" name="submit" class="btn btn-primary">add Grave Section</button>
                              </div>
                                </form>
                              </div>
                            </div>
